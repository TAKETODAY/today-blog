...
var localArticle = getStorage("article_md");
if(localArticle != null) {
	Article = localArticle
	$("#title").val(localArticle.title)
	createImage(localArticle.image)
	easyMDE.value(localArticle.markdown)
}

function saveToLocal() {
	Article.markdown = easyMDE.value()
	Article.title= $("#title").val()
	saveStorage("article_md",Article)
}
...
function check(){
	...
	Article.markdown = encodeURIComponent(markdown)
...
function createTagDOM(tags){
	...
	let article = getStorage("article_md")
	if(article != null) {
